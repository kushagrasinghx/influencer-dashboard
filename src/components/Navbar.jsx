...
export default function Navbar({ title }) {
  ...
  return (
    <div className="w-full h-20 flex items-center justify-between px-8 bg-white border-b border-[#eaeaea]">
      <h2 className="text-[1.5rem] font-semibold text-[#111] font-dm-sans">
        {title}
      </h2>
